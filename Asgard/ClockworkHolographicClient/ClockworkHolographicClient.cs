...
namespace ClockworkHolographicClient
{
    /// <summary>
    /// Updates, renders, and presents holographic content using Direct3D.
    /// </summary>
    internal class ClockworkHolographicClientMain : IDisposable
    {

#if DRAW_SAMPLE_CONTENT
        // Renders a colorful holographic cube that's 20 centimeters wide. This sample content
        // is used to demonstrate world-locked rendering.
        private SpritesRenderer        spritesRenderer;
...
#if DRAW_SAMPLE_CONTENT
            spritesRenderer.ReleaseDeviceDependentResources();
#endif
        ...
        {
#if DRAW_SAMPLE_CONTENT
            spritesRenderer.CreateDeviceDependentResourcesAsync();
#endif
        }
